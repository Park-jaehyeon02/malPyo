...
[![말표 프로젝트 데모 영상](http://img.youtube.com/vi/xGOSdfRZlWw/0.jpg)](https://www.youtube.com/watch?v=xGOSdfRZlWw)



**말표(Mal-Pyo)** 는 시각장애인이 프레젠테이션을 독립적으로 준비하고 발표할 수 있도록 돕는 음성 기반 AI 도우미입니다.
...
│  │faster-whisper│ │ GPT-4o   │ │  MeloTTS     │  │
│  │ Large-v3-   │ │ (교체가능) │ │  (GPU 가속)  │  │
│  │  turbo      │ │ Ollama   │ │  pyttsx3     │  │
│  │ (GPU/CUDA)  │ │ llama-cpp│ │  (폴백)      │  │
│  └─────────────┘ └──────────┘ └───────────────┘  │
└──────────────────────────────────────────────────┘
```
